...
* -i (--show-internal) - показать оверхед профилировщика
* -s (--show-system) - показать системные функции
* -c (--show-cuda) - показать функции libcuda
* -u (--show-unknown) - показать неизвестные функции (имена которых не удалось получить)
* -a (--show-all) - показать всё (кроме unknown)
